...
namespace Sample.Services {
  ...
  {
    static readonly string __ServiceName = "Sample.GrpcService.Service2";
    ...
    {
      get { return global::Sample.Services.Service2Reflection.Descriptor.Services[0]; }
    }
    ...
    /// <summary>Client for Service2</summary>
    public partial class Service2Client : grpc::ClientBase<Service2Client>
    {
      /// <summary>Creates a new client for Service2</summary>
      /// <param name="channel">The channel to use to make remote calls.</param>
      public Service2Client(grpc::Channel channel) : base(channel)
      {
      }
      /// <summary>Creates a new client for Service2 that uses a custom <c>CallInvoker</c>.</summary>
      /// <param name="callInvoker">The callInvoker to use to make remote calls.</param>
      public Service2Client(grpc::CallInvoker callInvoker) : base(callInvoker)
      {
      }
      /// <summary>Protected parameterless constructor to allow creation of test doubles.</summary>
      protected Service2Client() : base()
      {
      }
      /// <summary>Protected constructor to allow creation of configured clients.</summary>
      /// <param name="configuration">The client configuration.</param>
      protected Service2Client(ClientBaseConfiguration configuration) : base(configuration)
      {
      }
      ...
      protected override Service2Client NewInstance(ClientBaseConfiguration configuration)
      {
        return new Service2Client(configuration);
      }
    }
