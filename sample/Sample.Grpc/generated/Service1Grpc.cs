...
namespace Sample.Services {
  public static partial class Service1
  {
    ...
    static readonly grpc::Method<global::Sample.Messages.Request1, global::Sample.Messages.Response1> __Method_ClientStreamAPI = new grpc::Method<global::Sample.Messages.Request1, global::Sample.Messages.Response1>(
    ...
    static readonly grpc::Method<global::Sample.Messages.Request1, global::Sample.Messages.Response1> __Method_DuplexStreamingAPI = new grpc::Method<global::Sample.Messages.Request1, global::Sample.Messages.Response1>(
    ...
    public abstract partial class Service1Base
    {
      ...
      public virtual global::System.Threading.Tasks.Task<global::Sample.Messages.Response1> ClientStreamAPI(grpc::IAsyncStreamReader<global::Sample.Messages.Request1> requestStream, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
      ...
      public virtual global::System.Threading.Tasks.Task DuplexStreamingAPI(grpc::IAsyncStreamReader<global::Sample.Messages.Request1> requestStream, grpc::IServerStreamWriter<global::Sample.Messages.Response1> responseStream, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public partial class Service1Client : grpc::ClientBase<Service1Client>
    {
      ...
      public virtual grpc::AsyncClientStreamingCall<global::Sample.Messages.Request1, global::Sample.Messages.Response1> ClientStreamAPI(grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return ClientStreamAPI(new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual grpc::AsyncClientStreamingCall<global::Sample.Messages.Request1, global::Sample.Messages.Response1> ClientStreamAPI(grpc::CallOptions options)
      {
      ...
      {
        return DuplexStreamingAPI(new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual grpc::AsyncDuplexStreamingCall<global::Sample.Messages.Request1, global::Sample.Messages.Response1> DuplexStreamingAPI(grpc::CallOptions options)
      {
        return CallInvoker.AsyncDuplexStreamingCall(__Method_DuplexStreamingAPI, null, options);
      }
    ...
    public static grpc::ServerServiceDefinition BindService(Service1Base serviceImpl)
    {
      return grpc::ServerServiceDefinition.CreateBuilder()
          ...
          .AddMethod(__Method_API2, serviceImpl.API2)
